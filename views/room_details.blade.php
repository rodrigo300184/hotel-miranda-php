@extends('layout')
@section('room_details', 'Room Details')
...
<section class="rooms-details">
    ...
    <div class="availability--white">
        ...
        <form class="availability_form" id="availabilityForm">
                ...
                >
                <input
                  class="availability_input_rdetails"
                  type="date"
                  name="checkIn"
                  id="detailsCheckIn"
                ...
                />
                <label class="label-text label-text--black" for="checkIn"
                  >Message (Special resquest)</label
                >
                <textarea
                  class="availability_text-area"
                  name="message"
                  id="detailsMessage"
                  cols="30"
                  rows="3"
                ...
                ></textarea>
                <input
                  class="button button_big button_big--gold button_text"
                  type="submit"
    ...
    <!-- <section class="pageDetailsAvailability">
            ...
            <div class="pageDetailsAvailability__formContainer">
              <p
                class="pageDetailsAvailability__formErrorMessage"
                id="formErrorMessage"
              >
                Please, check the remark fields
              </p>
              
              <div
                class="pageDetailsAvailability__modalContainer pageDetailsAvailability__modalContainer-hidden"
              ...
              >
                <div class="pageDetailsAvailability__modal">
                  ...
                  <button
                    class="utton button_big button_big--gold button_big--centered button_text"
                    id="modalBtn"
                  >
                    ACEPT
                  </button>
