...
@section('content')
   ...
   <section class="banner">
      ...
      <h1
        class="banner-main-title main-title main-title-white about-title rooms-main-title"
      >
        New Details
      </h1>
      <div class="breadcrumb">
        <a href="./index.php" class="a breadcrumb_a">Home</a
        ><span class="breadcrumb_line">|</span
        ><span class="breadcrumb_current">Contact</span>
      </div>
    </section>
    <section class="contact">
      ...
      <div class="contact_card_container">
        ...
        <div class="contact_card">
          ...
          <div class="contact_card_text-container">
            ...
            <p
              class="contact_card_text-container_data contact_card_text-container_data--phone"
            >
      ...
      <!-- Contact Form -->
      <form action="/contact.php" method="POST" class="contact_form" id="">
        <div class="contact_form_container">
          <div class="contact_form_container--inner">
            ...
            />
            <input
              class="contact_input contact_input_phone"
              type="text"
              name="phone"
              id="phone"
        ...
        ></textarea>
        <input
          class="button button_centered button_regular button_regular--gold button_text"
          type="submit"
          value="SEND"
        />
      </form>
