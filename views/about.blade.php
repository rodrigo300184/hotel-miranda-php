...
<section class="amenities">
    <div class="amenities_container">
        <div class="amenities_container_item">
            <img class="amenities_container_item-breakfast" src="./resources/icons/amenities/breakfast.svg" alt="breakfast" />
            <h4 class="amenities_container_item-text">BREAKFAST</h4>
        </div>
        <div class="amenities_container_item">
            <img class="amenities_container_item-pickup" src="./resources/icons/amenities/pickup.png" alt="airport pickup" />
            <h4 class="amenities_container_item-text">AIRPORT PICKUP</h4>
        </div>
        <div class="amenities_container_item">
            <img class="amenities_container_item-guide" src="./resources/icons/amenities/guide.svg" alt="city guide" />
            <h4 class="amenities_container_item-text">CITY GUIDE</h4>
        </div>
        <div class="amenities_container_item bbq--off">
            <img class="amenities_container_item-bbq" src="./resources/icons/amenities/bbq.svg" alt="barbecue" />
            <h4 class="amenities_container_item-text">BBQ PARTY</h4>
        </div>
        <div class="amenities_container_item">
            <img class="amenities_container_item-luxury" src="./resources/icons/amenities/luxury.svg" alt="luxury room" />
...
<section class="counter">
    ...
    <div class="facts-swiper">
        <div class="swiper-wrapper">
            <div class="swiper-slide"><img src="./resources/assets/counter/happy-woman.jpg" alt="happy woman working"></div>
            <div class="swiper-slide"><img src="./resources/assets/counter/meeting.jpg" alt="people in meeting"></div>
            <div class="swiper-slide"><img src="./resources/assets/counter/party.jpg" alt="people drinking in party"></div>
        </div>
